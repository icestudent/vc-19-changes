...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    #elif defined _ACRT_BUILD && defined CRTDLL
        #define _ACRTIMP __declspec(dllexport)
    #else
        #ifdef _DLL
    ...
    #elif defined _DCRT_BUILD && defined CRTDLL
        #define _DCRTIMP __declspec(dllexport)
    #else
        #ifdef _DLL
...
// CRT_REFACTOR TODO PHASE3 This #define was added to fix build breaks in Windows
// where time_t and size_t are defined with other types, causing conflicts.  We
// should remove those conflicting typedefs and fix the resulting fallout.
