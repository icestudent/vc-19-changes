...
_CRT_BEGIN_C_HEADER
    ...
    _DCRTIMP _CRTALLOCATOR char* __cdecl _getcwd(
        _Out_writes_opt_(_SizeInBytes) char* _DstBuf,
        _In_                           int   _SizeInBytes
        );

    _Check_return_ _Ret_maybenull_z_
    _DCRTIMP _CRTALLOCATOR char* __cdecl _getdcwd(
        _In_                           int   _Drive,
        _Out_writes_opt_(_SizeInBytes) char* _DstBuf,
        _In_                           int   _SizeInBytes
        );
    ...
    _Check_return_ _DCRTIMP int __cdecl _chdir(_In_z_ char const* _Path);
