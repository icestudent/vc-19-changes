...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    #define _SWPRINTFS_DEPRECATED _CRT_DEPRECATE_TEXT(                       \
            "swprintf has been changed to conform with the ISO C standard, " \
            "adding an extra character count parameter. To use traditional " \
...
_CRT_STDIO_INLINE int __CRTDECL _vsnwprintf_l(
    _Out_writes_(_BufferCount)              wchar_t*       const _Buffer,
...
#pragma warning(push)
#pragma warning(disable:4141 4996 4793) // Suppress double deprecation warnings

__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_2_ARGLIST_EX(
    int, __RETURN_POLICY_SAME, _CRT_STDIO_INLINE _SWPRINTFS_DEPRECATED, __CRTDECL, __swprintf_l, __vswprintf_l, _vswprintf_s_l,
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_1_ARGLIST_EX(
    int, __RETURN_POLICY_SAME, _CRT_STDIO_INLINE _SWPRINTFS_DEPRECATED, __CRTDECL, _swprintf, _swprintf_s, _vswprintf, vswprintf_s,
    _Pre_notnull_ _Post_z_,       wchar_t,        _Buffer,
    _In_z_ _Printf_format_string_ wchar_t const*, _Format
    )
    ...
    ...)
{
    ...
    #pragma warning(disable: 4141 4412 4793 4996 6054)
        ...
        _CRT_STDIO_INLINE int swprintf(
            _Pre_notnull_ _Post_z_        wchar_t*       const _Buffer,
            _In_z_ _Printf_format_string_ wchar_t const* const _Format,
            ...) throw()
        {
        ...
        _CRT_STDIO_INLINE int _swprintf_l(
            _Pre_notnull_ _Post_z_                  wchar_t*       const _Buffer,
            _In_z_ _Printf_format_string_params_(0) wchar_t const* const _Format,
            _In_opt_                                _locale_t      const _Locale,
            ...) throw()
