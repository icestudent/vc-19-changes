...
typedef struct _CrtMemState
{
    ...
    #define _CrtSetDbgFlag(f)                   ((int)0)
        ...
        // Bitfield that controls CRT heap behavior
        _ACRTIMP extern int _crtDbgFlag;

        // Flag to control whether the CRT breaks on allocation
        _ACRTIMP extern long _crtBreakAlloc; 
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    ...
    _DCRTIMP errno_t __cdecl _dupenv_s_dbg(
        _Outptr_result_buffer_maybenull_(*_PBufferSizeInBytes)
        _Outptr_result_z_ char**      _PBuffer,
    ...
    _DCRTIMP errno_t __cdecl _wdupenv_s_dbg(
        _Outptr_result_buffer_maybenull_(*_PBufferSizeInWords)
        _Outptr_result_z_ wchar_t**      _PBuffer,
