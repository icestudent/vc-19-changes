...
** __MACHINECRT_UNSUPPORTED         : CRT_UNSUPPORTED only
** __MACHINEARM_CRT_UNSUPPORTED     : ARM and CRT_UNSUPPORTED only  
** __MACHINEARM_CRT_UNSUPPORTED_X64 : ARM and 64-bit Arch only
** __MACHINECRT_UNSUPPORTED_X64     : CRT_UNSUPPORTED and x64 only
...
#define __MACHINECRT_UNSUPPORTED         __MACHINE
#define __MACHINEARM_CRT_UNSUPPORTED     __MACHINE
#define __MACHINEARM_CRT_UNSUPPORTED_X64 __MACHINE
#define __MACHINECRT_UNSUPPORTED_X64     __MACHINE
...
__MACHINECRT_UNSUPPORTED(unsigned char _BitScanForward64(unsigned long * _Index, unsigned __int64 _Mask))
...
__MACHINECRT_UNSUPPORTED(unsigned char _BitScanReverse64(unsigned long * _Index, unsigned __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(double _CopyDoubleFromInt64(__int64))
__MACHINEARM_CRT_UNSUPPORTED(float _CopyFloatFromInt32(__int32))
__MACHINEARM_CRT_UNSUPPORTED(__int32 _CopyInt32FromFloat(float))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _CopyInt64FromDouble(double))
__MACHINEARM_CRT_UNSUPPORTED(unsigned int _CountLeadingOnes(unsigned long))
__MACHINEARM_CRT_UNSUPPORTED(unsigned int _CountLeadingOnes64(unsigned __int64))
__MACHINEARM_CRT_UNSUPPORTED(unsigned int _CountLeadingSigns(long))
__MACHINEARM_CRT_UNSUPPORTED(unsigned int _CountLeadingSigns64(__int64))
__MACHINEARM_CRT_UNSUPPORTED(unsigned int _CountLeadingZeros(unsigned long))
__MACHINEARM_CRT_UNSUPPORTED(unsigned int _CountLeadingZeros64(unsigned __int64))
...
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedAdd(long volatile * _Addend, long _Value))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedAdd64(__int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedAdd64_acq(__int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedAdd64_nf(__int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedAdd64_rel(__int64 volatile * _Addend, __int64 _Value))
__MACHINEX86(long _InterlockedAddLargeStatistic(__int64 volatile * _Addend, long _Value))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedAdd_acq(long volatile * _Addend, long _Value))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedAdd_nf(long volatile * _Addend, long _Value))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedAdd_rel(long volatile * _Addend, long _Value))
...
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedAnd16_acq(short volatile * _Value, short _Mask))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedAnd16_nf(short volatile * _Value, short _Mask))
__MACHINEX64(short _InterlockedAnd16_np(short volatile * _Value, short _Mask))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedAnd16_rel(short volatile * _Value, short _Mask))
__MACHINEARM_CRT_UNSUPPORTED_X64(__int64 _InterlockedAnd64(__int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedAnd64_acq(__int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedAnd64_nf(__int64 volatile * _Value, __int64 _Mask))
__MACHINEX64(__int64 _InterlockedAnd64_np(__int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedAnd64_rel(__int64 volatile * _Value, __int64 _Mask))
__MACHINE(char _InterlockedAnd8(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedAnd8_acq(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedAnd8_nf(char volatile * _Value, char _Mask))
__MACHINEX64(char _InterlockedAnd8_np(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedAnd8_rel(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedAnd_acq(long volatile * _Value, long _Mask))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedAnd_nf(long volatile * _Value, long _Mask))
__MACHINEX64(long _InterlockedAnd_np(long volatile * _Value, long _Mask))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedAnd_rel(long volatile * _Value, long _Mask))
...
__MACHINECRT_UNSUPPORTED_X64(unsigned char _InterlockedCompareExchange128(__int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
__MACHINECRT_UNSUPPORTED(unsigned char _InterlockedCompareExchange128_acq(__int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
__MACHINECRT_UNSUPPORTED(unsigned char _InterlockedCompareExchange128_nf(__int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
...
__MACHINECRT_UNSUPPORTED(unsigned char _InterlockedCompareExchange128_rel(__int64 volatile * _Destination, __int64 _ExchangeHigh, __int64 _ExchangeLow, __int64 * _ComparandResult))
__MACHINE(short _InterlockedCompareExchange16(short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedCompareExchange16_acq(short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedCompareExchange16_nf(short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINEX64(short _InterlockedCompareExchange16_np(short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedCompareExchange16_rel(short volatile * _Destination, short _Exchange, short _Comparand))
__MACHINE(__int64 _InterlockedCompareExchange64(__int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedCompareExchange64_acq(__int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedCompareExchange64_nf(__int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINEX64(__int64 _InterlockedCompareExchange64_np(__int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedCompareExchange64_rel(__int64 volatile * _Destination, __int64 _Exchange, __int64 _Comparand))
__MACHINE(char _InterlockedCompareExchange8(char volatile * _Destination, char _Exchange, char _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedCompareExchange8_acq(char volatile * _Destination, char _Exchange, char _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedCompareExchange8_nf(char volatile * _Destination, char _Exchange, char _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedCompareExchange8_rel(char volatile * _Destination, char _Exchange, char _Comparand))
__MACHINE(void * _InterlockedCompareExchangePointer(void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(void * _InterlockedCompareExchangePointer_acq(void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(void * _InterlockedCompareExchangePointer_nf(void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEX64(void * _InterlockedCompareExchangePointer_np(void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(void * _InterlockedCompareExchangePointer_rel(void * volatile * _Destination, void * _Exchange, void * _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedCompareExchange_acq(long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedCompareExchange_nf(long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINEX64(long _InterlockedCompareExchange_np(long volatile * _Destination, long _Exchange, long _Comparand))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedCompareExchange_rel(long volatile * _Destination, long _Exchange, long _Comparand))
...
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedDecrement16_acq(short volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedDecrement16_nf(short volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedDecrement16_rel(short volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED_X64(__int64 _InterlockedDecrement64(__int64 volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedDecrement64_acq(__int64 volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedDecrement64_nf(__int64 volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedDecrement64_rel(__int64 volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedDecrement_acq(long volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedDecrement_nf(long volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedDecrement_rel(long volatile * _Addend))
...
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedExchangeAdd16_nf(short volatile * _Addend, short _Value))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedExchangeAdd16_rel(short volatile * _Addend, short _Value))
__MACHINEARM_CRT_UNSUPPORTED_X64(__int64 _InterlockedExchangeAdd64(__int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedExchangeAdd64_acq(__int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedExchangeAdd64_nf(__int64 volatile * _Addend, __int64 _Value))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedExchangeAdd64_rel(__int64 volatile * _Addend, __int64 _Value))
__MACHINE(char _InterlockedExchangeAdd8(char volatile * _Addend, char _Value))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedExchangeAdd8_acq(char volatile * _Addend, char _Value))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedExchangeAdd8_nf(char volatile * _Addend, char _Value))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedExchangeAdd8_rel(char volatile * _Addend, char _Value))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedExchangeAdd_acq(long volatile * _Addend, long _Value))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedExchangeAdd_nf(long volatile * _Addend, long _Value))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedExchangeAdd_rel(long volatile * _Addend, long _Value))
__MACHINE(void * _InterlockedExchangePointer(void * volatile * _Target, void * _Value))
__MACHINEARM_CRT_UNSUPPORTED(void * _InterlockedExchangePointer_acq(void * volatile * _Target, void * _Value))
__MACHINEARM_CRT_UNSUPPORTED(void * _InterlockedExchangePointer_nf(void * volatile * _Target, void * _Value))
...
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedIncrement16_acq(short volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedIncrement16_nf(short volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedIncrement16_rel(short volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED_X64(__int64 _InterlockedIncrement64(__int64 volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedIncrement64_acq(__int64 volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedIncrement64_nf(__int64 volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedIncrement64_rel(__int64 volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedIncrement_acq(long volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedIncrement_nf(long volatile * _Addend))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedIncrement_rel(long volatile * _Addend))
...
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedOr16_acq(short volatile * _Value, short _Mask))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedOr16_nf(short volatile * _Value, short _Mask))
__MACHINEX64(short _InterlockedOr16_np(short volatile * _Value, short _Mask))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedOr16_rel(short volatile * _Value, short _Mask))
__MACHINEARM_CRT_UNSUPPORTED_X64(__int64 _InterlockedOr64(__int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedOr64_acq(__int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedOr64_nf(__int64 volatile * _Value, __int64 _Mask))
__MACHINEX64(__int64 _InterlockedOr64_np(__int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedOr64_rel(__int64 volatile * _Value, __int64 _Mask))
__MACHINE(char _InterlockedOr8(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedOr8_acq(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedOr8_nf(char volatile * _Value, char _Mask))
__MACHINEX64(char _InterlockedOr8_np(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedOr8_rel(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedOr_acq(long volatile * _Value, long _Mask))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedOr_nf(long volatile * _Value, long _Mask))
__MACHINEX64(long _InterlockedOr_np(long volatile * _Value, long _Mask))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedOr_rel(long volatile * _Value, long _Mask))
...
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedXor16_acq(short volatile * _Value, short _Mask))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedXor16_nf(short volatile * _Value, short _Mask))
__MACHINEX64(short _InterlockedXor16_np(short volatile * _Value, short _Mask))
__MACHINEARM_CRT_UNSUPPORTED(short _InterlockedXor16_rel(short volatile * _Value, short _Mask))
__MACHINEARM_CRT_UNSUPPORTED_X64(__int64 _InterlockedXor64(__int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedXor64_acq(__int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedXor64_nf(__int64 volatile * _Value, __int64 _Mask))
__MACHINEX64(__int64 _InterlockedXor64_np(__int64 volatile * _Value, __int64 _Mask))
__MACHINEARM_CRT_UNSUPPORTED(__int64 _InterlockedXor64_rel(__int64 volatile * _Value, __int64 _Mask))
__MACHINE(char _InterlockedXor8(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedXor8_acq(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedXor8_nf(char volatile * _Value, char _Mask))
__MACHINEX64(char _InterlockedXor8_np(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(char _InterlockedXor8_rel(char volatile * _Value, char _Mask))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedXor_acq(long volatile * _Value, long _Mask))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedXor_nf(long volatile * _Value, long _Mask))
__MACHINEX64(long _InterlockedXor_np(long volatile * _Value, long _Mask))
__MACHINEARM_CRT_UNSUPPORTED(long _InterlockedXor_rel(long volatile * _Value, long _Mask))
...
__MACHINECRT_UNSUPPORTED(__int64 _ReadStatusReg(int))
__MACHINECRT_UNSUPPORTED(unsigned __int64 __getReg(int))
__MACHINECRT_UNSUPPORTED(unsigned __int64 __getCallerReg(int))
__MACHINECRT_UNSUPPORTED(double __getRegFp(int))
__MACHINECRT_UNSUPPORTED(double __getCallerRegFp(int))
...
__MACHINECRT_UNSUPPORTED(void _WriteStatusReg(int, __int64))
__MACHINECRT_UNSUPPORTED(void __setReg(int, unsigned __int64))
__MACHINECRT_UNSUPPORTED(void __setCallerReg(int, unsigned __int64))
__MACHINECRT_UNSUPPORTED(void __setRegFp(int, double))
__MACHINECRT_UNSUPPORTED(void __setCallerRegFp(int, double))
...
__MACHINECRT_UNSUPPORTED(void __addx18byte(unsigned long, unsigned char))
__MACHINECRT_UNSUPPORTED(void __addx18dword(unsigned long, unsigned long))
__MACHINECRT_UNSUPPORTED(void __addx18qword(unsigned long, unsigned __int64))
__MACHINECRT_UNSUPPORTED(void __addx18word(unsigned long, unsigned short))
...
__MACHINEARM_CRT_UNSUPPORTED(void __emit(unsigned __int32))
...
__MACHINEARM_CRT_UNSUPPORTED(unsigned int __hvc(unsigned int, ...))
__MACHINECRT_UNSUPPORTED(void __break(int))
...
__MACHINECRT_UNSUPPORTED(void __incx18byte(unsigned long))
__MACHINECRT_UNSUPPORTED(void __incx18dword(unsigned long))
__MACHINECRT_UNSUPPORTED(void __incx18qword(unsigned long))
__MACHINECRT_UNSUPPORTED(void __incx18word(unsigned long))
...
__MACHINEARM_CRT_UNSUPPORTED(__int16 __iso_volatile_load16(const volatile __int16 *))
__MACHINEARM_CRT_UNSUPPORTED(__int32 __iso_volatile_load32(const volatile __int32 *))
__MACHINEARM_CRT_UNSUPPORTED(__int64 __iso_volatile_load64(const volatile __int64 *))
__MACHINEARM_CRT_UNSUPPORTED(__int8 __iso_volatile_load8(const volatile __int8 *))
__MACHINEARM_CRT_UNSUPPORTED(void __iso_volatile_store16(volatile __int16 *, __int16))
__MACHINEARM_CRT_UNSUPPORTED(void __iso_volatile_store32(volatile __int32 *, __int32))
__MACHINEARM_CRT_UNSUPPORTED(void __iso_volatile_store64(volatile __int64 *, __int64))
__MACHINEARM_CRT_UNSUPPORTED(void __iso_volatile_store8(volatile __int8 *, __int8))
...
__MACHINECRT_UNSUPPORTED_X64(__int64 __mulh(__int64, __int64))
...
__MACHINEARM_CRT_UNSUPPORTED(void __cdecl __prefetch(const void *))
...
__MACHINECRT_UNSUPPORTED(unsigned char __readx18byte(unsigned long))
__MACHINECRT_UNSUPPORTED(unsigned long __readx18dword(unsigned long))
__MACHINECRT_UNSUPPORTED(unsigned __int64 __readx18qword(unsigned long))
__MACHINECRT_UNSUPPORTED(unsigned short __readx18word(unsigned long))
__MACHINEX86_X64(unsigned long __segmentlimit(unsigned long))
__MACHINEARM_CRT_UNSUPPORTED(void __sev(void))
...
__MACHINEARM_CRT_UNSUPPORTED(void __static_assert(int, const char *))
...
__MACHINEARM_CRT_UNSUPPORTED(unsigned int __svc(unsigned int, ...))
__MACHINECRT_UNSUPPORTED(unsigned int __hlt(unsigned int, ...))
__MACHINECRT_UNSUPPORTED(unsigned int __sys(int, __int64))
...
__MACHINECRT_UNSUPPORTED_X64(unsigned __int64 __umulh(unsigned __int64, unsigned __int64))
...
__MACHINEARM_CRT_UNSUPPORTED(void __wfe(void))
__MACHINEARM_CRT_UNSUPPORTED(void __wfi(void))
...
__MACHINECRT_UNSUPPORTED(void __writex18byte(unsigned long, unsigned char))
__MACHINECRT_UNSUPPORTED(void __writex18dword(unsigned long, unsigned long))
__MACHINECRT_UNSUPPORTED(void __writex18qword(unsigned long, unsigned __int64))
__MACHINECRT_UNSUPPORTED(void __writex18word(unsigned long, unsigned short))
__MACHINEARM_CRT_UNSUPPORTED(void __yield(void))
__MACHINE(unsigned char _bittest(long const *, long))
__MACHINECRT_UNSUPPORTED_X64(unsigned char _bittest64(__int64 const *, __int64))
__MACHINE(unsigned char _bittestandcomplement(long *, long))
__MACHINECRT_UNSUPPORTED_X64(unsigned char _bittestandcomplement64(__int64 *, __int64))
__MACHINE(unsigned char _bittestandreset(long *, long))
__MACHINECRT_UNSUPPORTED_X64(unsigned char _bittestandreset64(__int64 *, __int64))
__MACHINE(unsigned char _bittestandset(long *, long))
__MACHINECRT_UNSUPPORTED_X64(unsigned char _bittestandset64(__int64 *, __int64))
...
__MACHINECRT_UNSUPPORTED_X64(unsigned char _interlockedbittestandreset64(__int64 volatile *, __int64))
__MACHINEARM_CRT_UNSUPPORTED(unsigned char _interlockedbittestandreset_acq(long volatile *, long))
__MACHINEARM_CRT_UNSUPPORTED(unsigned char _interlockedbittestandreset_nf(long volatile *, long))
__MACHINEARM_CRT_UNSUPPORTED(unsigned char _interlockedbittestandreset_rel(long volatile *, long))
__MACHINECRT_UNSUPPORTED(unsigned char _interlockedbittestandreset64_acq(__int64 volatile *, __int64))
__MACHINECRT_UNSUPPORTED(unsigned char _interlockedbittestandreset64_rel(__int64 volatile *, __int64))
__MACHINECRT_UNSUPPORTED(unsigned char _interlockedbittestandreset64_nf(__int64 volatile *, __int64))
__MACHINE(unsigned char _interlockedbittestandset(long volatile *, long))
__MACHINECRT_UNSUPPORTED_X64(unsigned char _interlockedbittestandset64(__int64 volatile *, __int64))
__MACHINEARM_CRT_UNSUPPORTED(unsigned char _interlockedbittestandset_acq(long volatile *, long))
__MACHINEARM_CRT_UNSUPPORTED(unsigned char _interlockedbittestandset_nf(long volatile *, long))
__MACHINEARM_CRT_UNSUPPORTED(unsigned char _interlockedbittestandset_rel(long volatile *, long))
__MACHINECRT_UNSUPPORTED(unsigned char _interlockedbittestandset64_acq(__int64 volatile *, __int64))
__MACHINECRT_UNSUPPORTED(unsigned char _interlockedbittestandset64_rel(__int64 volatile *, __int64))
__MACHINECRT_UNSUPPORTED(unsigned char _interlockedbittestandset64_nf(__int64 volatile *, __int64))
__MACHINECRT_UNSUPPORTED(__int32 __crc32b(__int32, __int32))
__MACHINECRT_UNSUPPORTED(__int32 __crc32h(__int32, __int32))
__MACHINECRT_UNSUPPORTED(__int32 __crc32w(__int32, __int32))
__MACHINECRT_UNSUPPORTED(__int32 __crc32x(__int32, __int64))
__MACHINECRT_UNSUPPORTED(__int32 __crc32cb(__int32, __int32))
__MACHINECRT_UNSUPPORTED(__int32 __crc32ch(__int32, __int32))
__MACHINECRT_UNSUPPORTED(__int32 __crc32cw(__int32, __int32))
__MACHINECRT_UNSUPPORTED(__int32 __crc32cx(__int32, __int64))
...
__MACHINEARM_CRT_UNSUPPORTED_X64(int __cdecl _setjmpex(jmp_buf))
