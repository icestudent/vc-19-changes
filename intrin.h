...
__MACHINEX86(void __writecr0(unsigned long))
__MACHINEX64(void __writecr3(unsigned __int64))
__MACHINEX86(void __writecr3(unsigned long))
__MACHINEX64(void __writecr4(unsigned __int64))
__MACHINEX86(void __writecr4(unsigned long))
__MACHINEX64(void __writecr8(unsigned __int64))
__MACHINEX86(void __writecr8(unsigned long))
...
__MACHINE(unsigned long __cdecl _lrotl(_In_ unsigned long, _In_ int))
__MACHINE(unsigned long __cdecl _lrotr(_In_ unsigned long, _In_ int))
...
__MACHINE(_Check_return_ unsigned short __cdecl _rotl16(unsigned short _Value, unsigned char _Shift))
__MACHINE(unsigned __int64 __cdecl _rotl64(_In_ unsigned __int64 _Value, _In_ int _Shift))
__MACHINE(_Check_return_ unsigned char __cdecl _rotl8(unsigned char _Value, unsigned char _Shift))
__MACHINE(unsigned int __cdecl _rotr(_In_ unsigned int _Value, _In_ int _Shift))
__MACHINE(_Check_return_ unsigned short __cdecl _rotr16(unsigned short _Value, unsigned char _Shift))
__MACHINE(unsigned __int64 __cdecl _rotr64(_In_ unsigned __int64 _Value, _In_ int _Shift))
__MACHINE(_Check_return_ unsigned char __cdecl _rotr8(unsigned char _Value, unsigned char _Shift))
...
__MACHINEX86_X64(unsigned char __cdecl _addcarry_u8(unsigned char _Carry, unsigned char _Value1, unsigned char _Value2, unsigned char * _Sum))
__MACHINEX86_X64(unsigned char __cdecl _subborrow_u8(unsigned char _Borrow, unsigned char _Value1, unsigned char _Value2, unsigned char * _Difference))
__MACHINEX86_X64(unsigned char __cdecl _addcarry_u16(unsigned char _Carry, unsigned short _Value1, unsigned short _Value2, unsigned short * _Sum))
__MACHINEX86_X64(unsigned char __cdecl _subborrow_u16(unsigned char _Borrow, unsigned short _Value1, unsigned short _Value2, unsigned short * _Difference))
__MACHINEX86_X64(unsigned char __cdecl _addcarry_u32(unsigned char _Carry, unsigned int _Value1, unsigned int _Value2, unsigned int * _Sum))
__MACHINEX86_X64(unsigned char __cdecl _subborrow_u32(unsigned char _Borrow, unsigned int _Value1, unsigned int _Value2, unsigned int * _Difference))
__MACHINEX64(unsigned char __cdecl _addcarry_u64(unsigned char _Carry, unsigned __int64 _Value1, unsigned __int64 _Value2, unsigned __int64 * _Sum))
__MACHINEX64(unsigned char __cdecl _subborrow_u64(unsigned char _Borrow, unsigned __int64 _Value1, unsigned __int64 _Value2, unsigned __int64 * _Difference))
