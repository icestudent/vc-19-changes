...
// the very last thing on detach notifications.
    ...
    _DCRTIMP uintptr_t __cdecl _beginthread(
        _In_     _beginthread_proc_type _StartAddress,
        _In_     unsigned               _StackSize,
        _In_opt_ void*                  _ArgList
        );

    _DCRTIMP void __cdecl _endthread(void);

    _DCRTIMP uintptr_t __cdecl _beginthreadex(
    ...
    _DCRTIMP void __cdecl _endthreadex(
        _In_ unsigned _Retval
        );
