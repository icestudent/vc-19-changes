...
_ACRTIMP errno_t __cdecl _wasctime_s(
    _Out_writes_(_SizeInWords) _Post_readable_size_(26) wchar_t*         _Buffer,
...
_ACRTIMP errno_t __cdecl _wstrdate_s(
    _Out_writes_(_SizeInWords) _Post_readable_size_(9) wchar_t* _Buffer,
    _In_                                               size_t   _SizeInWords
    );
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0(
    wchar_t*, __RETURN_POLICY_DST, _ACRTIMP, _wstrdate,
...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0(
    wchar_t*, __RETURN_POLICY_DST, _ACRTIMP, _wstrtime,
    _Out_writes_z_(9), wchar_t, _Buffer
    )
...
//
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
#if !defined RC_INVOKED && !defined __midl && !defined _INC_WTIME_INL && !defined _VCRT_BUILD && !defined _CORECRT_BUILD
    #pragma warning(push)
