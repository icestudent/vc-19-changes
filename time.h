...
__DEFINE_CPP_OVERLOAD_STANDARD_FUNC_0_0(
    char*, __RETURN_POLICY_DST, _ACRTIMP, _strdate,
...
//
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
#if !defined RC_INVOKED && !defined __midl && !defined _INC_TIME_INL && !defined _VCRT_BUILD && !defined _CORECRT_BUILD
            ...
            )
        {
            ...
            static __inline errno_t __CRTDECL ctime_s(
                _Out_ char*         const _Buffer,
                _In_  size_t        const _SizeInBytes,
                _In_  time_t const* const _Time
                )
            {
