...
//
// The C Standard Library <math.h> header.
//
#ifndef _INC_MATH
#define _INC_MATH
...
// This value of INFINITY causes warning C4756:  overflow in constant arithmetic.
// The warning is by-design and desired.
...
_Check_return_ _ACRTIMP short __cdecl _d_int(_In_ double* _Px, _In_ short _Xexp);
_Check_return_ _ACRTIMP short __cdecl _ld_int(_In_ long double* _Px, _In_ short _Xexp);
_Check_return_ _ACRTIMP short __cdecl _fd_int(_In_ float* _Px, _In_ short _Xexp);

_Check_return_ _ACRTIMP short __cdecl _dscale(_In_ double* _Px, _In_ long _Lexp);
_Check_return_ _ACRTIMP short __cdecl _ldscale(_In_ long double* _Px, _In_ long _Lexp);
_Check_return_ _ACRTIMP short __cdecl _fdscale(_In_ float* _Px, _In_ long _Lexp);

_Check_return_ _ACRTIMP short __cdecl _dunscale(_In_ short* _Pex, _In_ double* _Px);
_Check_return_ _ACRTIMP short __cdecl _ldunscale(_In_ short* _Pex, _In_ long double* _Px);
_Check_return_ _ACRTIMP short __cdecl _fdunscale(_In_ short* _Pex, _In_ float* _Px);

_Check_return_ _ACRTIMP short __cdecl _dexp(_In_ double* _Px, _In_ double _Y, _In_ long _Eoff);
_Check_return_ _ACRTIMP short __cdecl _ldexp(_In_ long double* _Px, _In_ long double _Y, _In_ long _Eoff);
_Check_return_ _ACRTIMP short __cdecl _fdexp(_In_ float* _Px, _In_ float _Y, _In_ long _Eoff);

_Check_return_ _ACRTIMP short __cdecl _dnorm(_In_ unsigned short* _Ps);
_Check_return_ _ACRTIMP short __cdecl _fdnorm(_In_ unsigned short* _Ps);

_Check_return_ _ACRTIMP double __cdecl _dpoly(_In_ double _X, _In_ double const* _Tab, _In_ int _N);
_Check_return_ _ACRTIMP long double __cdecl _ldpoly(_In_ long double _X, _In_ long double const* _Tab, _In_ int _N);
_Check_return_ _ACRTIMP float __cdecl _fdpoly(_In_ float _X, _In_ float const* _Tab, _In_ int _N);
...
_Check_return_ _ACRTIMP double __cdecl nan(_In_ char const*);
...
_Check_return_ _ACRTIMP float     __cdecl nanf(_In_ char const*);
...
_Check_return_ _ACRTIMP long double __cdecl nanl(_In_ char const*);
